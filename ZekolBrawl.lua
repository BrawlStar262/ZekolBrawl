...
if supported then
    ...
    if not ok then
        warn("ZekolBrawl: " .. supported.Name .. " failed to start - " .. tostring(err))
    end
    return
end

if type(_G.ZekolBrawlLoader) == "table" then
    pcall(function()
        _G.ZekolBrawlLoader.Window:Destroy()
    end)
end
_G.ZekolBrawlLoader = {}
...
_G.ZekolBrawlLoader.Window = Window
